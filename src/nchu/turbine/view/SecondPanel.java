...
public class SecondPanel extends JPanel implements IListBodyPanel{
...
//		bodyPanel.setPreferredSize(new Dimension(380, 700));
		...
		JButton button_2 = new JButton("\u5DF2\u5B8C\u6210");
